    ...
    internal class W65C816
    {
        ...
        public static (OpCode, AddressingMode) OpCodeLookup(byte opcode)
        {
            return opcode switch
            {
                ...
                0x7c => (OpCode.JMP, AddressingMode.AbsoluteLong),
                ...
                0x96 => (OpCode.STX, AddressingMode.DirectIndexedWithX),
                0x97 => (OpCode.STA, AddressingMode.DirectIndirectLongIndexed),
                0x98 => (OpCode.TYA, AddressingMode.Implied),
                0x99 => (OpCode.STY, AddressingMode.AbsoluteIndexedWithY),
                ...
                0xd4 => (OpCode.PEI, AddressingMode.DirectIndirect),
                ...
                0xdc => (OpCode.JMP, AddressingMode.AbsoluteIndexedIndirect),
                ...
                0xf4 => (OpCode.PEA, AddressingMode.Absolute),
